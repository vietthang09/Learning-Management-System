...
function statusDealine(day, submission) {
  var today = new Date();
  var deadline = new Date(day);
  if (today > deadline && submission == null) {
...
function AssignmentCard(props) {
  ...
  let fN;
  submission == null ? (fN = "Choose file") : (fN = submission.file_name);
    ...
    <>
      <div
        className={
          ...
          statusDealine(assignment.deadline, submission)
        }
      >
        ...
        <div className={true ? "block flex space-x-10" : "hidden"}>
          <div
            className={
              submission == null
                ? "hidden"
                : "block flex items-center space-x-5"
            }
          >
            <label
              htmlFor="file"
            ...
            <a
              href={
                submission == null
                  ? ""
                  : "http://127.0.0.1:8000/api/download/" + submission.id
              }
            >
...
//           <div>
//             <span className="block text-lg font-medium">
//               {props.data.assignment.assignment_title}
//             </span>
//             <div className="flex mb-2">
//               <div
//                 className={
...
//               >
//                 <BookmarkIcon className="w-5 mr-1" />
//                 <span>{props.data.assignment.assignment_title}</span>
//               </div>
//               <div className="flex items-center text-xs font-bold text-gray-500">
//                 <ClockIcon className="w-5 mr-1" />
//                 <span>{dl}</span>
...
//                       </Dialog.Title>
//                       <div className="mt-2">
//                         <p className="text-sm text-gray-500">{props.data.assignment.assignment_content}</p>
//                       </div>
